...
namespace SwerveConstants
{
    ...
    const int FRspeedPort = 3; //13, 3
    const int FLspeedPort = 1; //11, 1
    const int BRspeedPort = 4; //18, 4
    const int BLspeedPort = 22; //15, 22

    const int FRanglePort = 5; //14, 5
    const int FLanglePort = 7; //12, 7
    const int BRanglePort = 10; //17, 10
    const int BLanglePort = 19; //16, 19

    const int FRencoder = 2; //62, 2
    const int FLencoder = 9; //10, 9
    const int BRencoder = 8; //8, 8
    const int BLencoder = 6; //42, 6
    
    const double FROFF = -93.78; //19.77, 
    const double FLOFF = -286.17; //109.952, 
    ...
    //TODO: tune, just copied angle pid
