...
class SwerveDrive
{
    ...
    private:
        ...
        // SwerveModule blModule_{SwerveConstants::BLanglePort, SwerveConstants::BLspeedPort, SwerveConstants::BLencoder, false, SwerveConstants::BLOFF};
