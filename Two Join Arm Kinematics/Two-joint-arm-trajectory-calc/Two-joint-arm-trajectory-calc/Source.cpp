...
int main()
{
	...
	TwoJointArmConstants::UPPER_ARM_LENGTH, TwoJointArmConstants::FOREARM_LENGTH, 2.0, 2.0 };
	...
	calc.generateCurvedTrajectory("04.csv", sTheta, sPhi, hX, hY, 1.138, 1);
	calc.generateCurvedTrajectory("40.csv", hTheta, hPhi, sX, sY, 1.138, -1);
